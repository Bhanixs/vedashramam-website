...
export const Route = createFileRoute("/vedabhavan")({
  head: () => ({
    meta: [
      { title: "Veda Ashramam / Vedabhavan — Karuvadikuppam, Puducherry" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Veda Ashramam / Vedabhavan" },
      {
  ...
  component: VedabhavanPage,
});

export function VedabhavanPage() {
  return (
    <PageShell transparentHeader>
      <PageBanner
        title="Veda Ashramam"
        subtitle="Vedabhavan — Preserving the Eternal Guru-Shishya Parampara in Karuvadikuppam"
        image={heroTemple}
      />
